...
export function WelcomePage({ onEnter }: WelcomePageProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0c0a09] font-serif overflow-hidden relative text-[#fafaf9]">
        ...
        <div className="max-w-3xl w-full space-y-16 text-center relative z-10">
          ...
          <div className="pt-8 flex flex-col items-center gap-8">
            ...
            <button
              ...
              className="group relative flex items-center gap-4 px-12 py-5 bg-stone-900 border border-stone-800 rounded-full text-lg font-medium hover:border-amber-500/50 transition-all duration-700 animate-slideUp"
            >
              <span className="text-stone-300">{buttonText}</span>
